...
# Plot it.
scatter(particles[1, :, :], particles[2, :, :], alpha=5 .* particles[3, :, :], color="black", label="")
plot!(pos[1, :], pos[2, :], label="true", color="green") #, xlims=[0, maximum(pos[1, :])], ylims=[0, maximum(pos[2, :])], color="green")
