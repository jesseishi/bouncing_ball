...
sampling_frequencies = {'sensor': 2, 'state_estimator': 4}
...
particle_filter_logger = DataLogger(MyBall.t, MyBall.x)  # TODO: In this case we don't have a starting value.
...
while running:
    ...
    if 'state_estimator' in events:
        particle_filter.estimate_state(MyBall.t, MyBall.t, MySensor.x_star)
